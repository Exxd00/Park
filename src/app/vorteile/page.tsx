...
import { features } from "@/data/seo-data";
import { Shield, ArrowRight, ExternalLink } from "lucide-react";

export const metadata: Metadata = {
  title: "Unsere Vorteile | ParkExpress24 Flughafen Nürnberg",
  description: "Warum ParkExpress24? Schlüssel behalten, 24/7 Shuttle, 5 Min zum Terminal, sichere Parkplätze. Alle Vorteile auf einen Blick.",
  keywords: [
    "parkexpress24 vorteile",
    "parken flughafen nürnberg schlüssel behalten",
    "shuttle flughafen nürnberg",
  ],
  alternates: {
    canonical: "https://park-express24.de/vorteile",
  },
};
          ...
          <div className="container px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-slate-300">
                Was macht ParkExpress24 besonders? Entdecken Sie unsere Vorteile
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {features.map((feature) => (
                  ...
                  >
                    ...
                    <h3 className="font-bold text-slate-800 text-lg mb-2">{feature.name}</h3>
                    <p className="text-sm text-slate-600 mb-4">{feature.headline}</p>
          ...
          <div className="container px-4">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-slate-300 mb-8">
                Buchen Sie jetzt Ihren Parkplatz und erleben Sie den Unterschied
              </p>
              <a
